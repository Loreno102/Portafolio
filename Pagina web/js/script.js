...
const T = {
  es: {
    ...
    v_drive: "Ver en Drive",
    v_drive_banner: "Ve todos los videos que he editado",
    tag_digital_comm: "Comunicación Digital",
    tag_postprod: "Posproducción",
    tag_narrative_edit: "Edición Narrativa",
    tag_transmedia: "Transmedia",
    tag_anim_2d: "Animación 2D",
    ...
    vp1d: "Dominio de herramientas de edición y animación (Premiere Pro, CapCut, After Effects) para crear Motion Graphics y piezas audiovisuales con sensibilidad narrativa transmedia.",
    ...
    vp3d: "Busco que cada edición ayude a que marcas y creadores conecten con su audiencia mediante contenido intencional y cuidado.",
    vp_statement: "Transformo material crudo en piezas audiovisuales con ritmo, intención y carácter. Desde el corte y la animación en Motion Graphics (Premiere, CapCut, After Effects) hasta la dirección de color y sonido, entrego contenido con criterio editorial pensado para destacar en cada plataforma.",
    ...
    sk3d: "Edición de video en Premiere Pro y CapCut, combinada con animaciones en Motion Graphics y After Effects."
  },
  en: {
    ...
    sk3n: "Post-production & Motion Graphics", sk3d: "Video editing in Premiere Pro and CapCut, combined with Motion Graphics animations and After Effects.",
    ...
    v_drive: "View on Drive",
    v_drive_banner: "See all the videos I've edited",
    tag_digital_comm: "Digital Communication",
    tag_postprod: "Post-production",
    tag_narrative_edit: "Narrative Editing",
    tag_transmedia: "Transmedia",
    tag_anim_2d: "2D Animation",
    ...
    vp1d: "Mastery of editing and animation tools (Premiere Pro, CapCut, After Effects) to create Motion Graphics and audiovisual pieces with transmedia narrative sensitivity.",
    ...
    vp3d: "I aim for every edit to help brands and creators connect with their audience through intentional, polished content.",
    vp_statement: "I transform raw footage into audiovisual pieces with rhythm, intention, and character. From editing and Motion Graphics (Premiere, CapCut, After Effects) to color and sound design, I deliver content with editorial vision built to stand out on every platform.",
